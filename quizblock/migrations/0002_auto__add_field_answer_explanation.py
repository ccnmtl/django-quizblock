...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.explanation'
        db.add_column('quizblock_answer', 'explanation', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Answer.explanation'
        db.delete_column('quizblock_answer', 'explanation')
