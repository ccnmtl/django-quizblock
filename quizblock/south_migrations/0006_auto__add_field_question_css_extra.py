...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.css_extra'
        db.add_column(u'quizblock_question', 'css_extra',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.css_extra'
        db.delete_column(u'quizblock_question', 'css_extra')
    ...
    models = {
        ...
        u'quizblock.answer': {
            ...
            'css_extra': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
        ...
        u'quizblock.question': {
            ...
            '_order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'css_extra': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'explanation': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
